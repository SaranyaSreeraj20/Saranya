        ...
        <div className='w-full min-h-screen flex flex-col bg-gray-100 '>
            <main className="flex-grow w-full md:max-w-4xl lg:max-w-5xl xl:max-w-6xl md:mx-auto px-2 sm:px-6 md:px-8 py-2 sm:py-6 md:py-10">
                <div className="flex flex-col shadow-lg md:shadow-2xl bg-[#4B164C] rounded-lg sm:rounded-xl md:rounded-3xl border border-gray-100 overflow-hidden">
                    <SearchHeader title='Contact Us' variant='back' align='center' />
                    <Help />
                    <div className="bg-white p-6 sm:p-10 md:p-16 rounded-t-3xl min-h-[50vh] flex flex-col items-center justify-center text-center">                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-['Aldrich'] text-[#4B164C] mb-4">How can we help?</h3>
