...
import StorageAndData from '../components/StorageAndData';

const Page48 = () => {
    return (
        <div className='w-full min-h-screen flex flex-col bg-gray-100 '>
            <main className="flex-grow w-full h-full md:max-w-4xl lg:max-w-5xl xl:max-w-6xl md:mx-auto px-2 sm:px-6 md:px-8 py-2 sm:py-6 md:py-10">
