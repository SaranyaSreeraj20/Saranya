...
const ProfileSidebar50 = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-transparent px-4 sm:px-6 md:px-8 pt-15 sm:pt-20 md:pt-24 lg:pt-5 overflow-y-auto">
      {/* POPUP CARD */}
            ...
            return (
              <div key={item.name}>
                <button
                  ...
                  className={`w-full text-left px-3 sm:px-4 md:px-5 py-3 sm:py-3.5 md:py-5 rounded-lg text-base sm:text-lg md:text-xl font-aldrich transition 
